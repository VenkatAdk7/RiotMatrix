...
- (void)viewDidLoad
{
    ...
    //self.homeServerTextField.text = @"http://superman1.eastus.cloudapp.azure.com:8008";
    //self.identityServerTextField.text = @"http://superman1.eastus.cloudapp.azure.com:8008";
